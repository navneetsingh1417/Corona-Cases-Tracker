		...
		<div class="row">
			<div class="col-md-6">
				<div class="card text-white bg-primary mb-3 mx-auto"
					...
					<div class="card-header mx-auto" style="font-size: 20px;">${country.country }</div>
					<div class="card-body mx-auto">
						<h4 class="card-title">Total Confirmed Cases</h4>
						<h4 class="card-text text-center">${country.totalconfirmed}</h4>
					</div>
				</div>
			...
			<div class="col-md-6">
				...
				<div class="card text-white bg-info mb-3 mx-auto"
					...
					<div class="card-body mx-auto">
						...
						<h4 class="card-text text-center">${country.active}</h4>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6">
				...
				<div class="card text-white bg-danger mb-3 mx-auto"
					...
					<div class="card-body mx-auto">
						...
						<h4 class="card-text text-center">${country.totaldeaths}</h4>
					</div>
				</div>
			...
			<div class="col-md-6">
				...
				<div class="card text-white bg-success mb-3 mx-auto"
					...
					<div class="card-body mx-auto">
						...
						<h4 class="card-text text-center">${country.totalrecovered}</h4>
					</div>
				</div>
			</div>
